...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_oryginal_path", type=str, default=None)                   # standard deviation value of spectrograms of our resampled data
    ...
    if args.test_oryginal_path:
        test_path = f"{args.test_oryginal_path}"     # directory of our test dataset on the instance
    else:
