...
if __name__ == "__main__":
    ...
    trv_dataset_encoded = concatenate_datasets([train_dataset_encoded, val_dataset_encoded]).shuffle(seed = 42)
    ...
    trainer = Trainer(
        ...
        train_dataset=trv_dataset_encoded,                                         # passing the encoded train set
