...
def get_feature_extractor(model_name: str, 
    ...
    if all((train_dataset_mean, train_dataset_std)):
        feature_extractor = AutoFeatureExtractor.from_pretrained(model_name, mean=train_dataset_mean, std=train_dataset_std, max_length=1024)
...
if __name__ == "__main__":
    ...
    model = WhisperForAudioClassification.from_pretrained(args.model_name, num_labels=num_labels, label2id=label2id, id2label=id2label, ignore_mismatched_sizes=True)
