...
if __name__ == "__main__":
    ...
    model.class_layernorm = nn.LayerNorm((768,), eps=1e-12, elementwise_affine=True)
    model.class_dropout = nn.Dropout(p=0.1, inplace=False)
    model.class_dense = nn.Linear(in_features=768, out_features=512, bias=True)
    model.class_layernorm2 = nn.LayerNorm((512,), eps=1e-12, elementwise_affine=True)
    model.classifier = nn.Linear(in_features=512, out_features=66, bias=True)
