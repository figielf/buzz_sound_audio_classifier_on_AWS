...
def get_feature_extractor(model_name: str, 
                          ...
                          patch_size: int=16) -> ASTFeatureExtractor:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--frequency_stride", type=int, default=10)
    ...
    feature_extractor = get_feature_extractor(args.model_name, args.train_dataset_mean, args.train_dataset_std, args.num_mel_bins, args.max_length, args.time_stride, args.frequency_stride, args.patch_size)
