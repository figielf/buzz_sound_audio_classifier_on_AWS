...
def get_feature_extractor(model_name: str, 
                          ...
                          num_mel_bins: Optional[int] = 128) -> ASTFeatureExtractor:
    """
    ...
    if all((train_dataset_mean, train_dataset_std)):
        feature_extractor = ASTFeatureExtractor.from_pretrained(model_name, mean=train_dataset_mean, std=train_dataset_std, sampling_rate=sampling_rate, max_length=max_length, num_mel_bins=num_mel_bins)
...
if __name__ == "__main__":
    ...
    feature_extractor = get_feature_extractor(args.model_name, args.train_dataset_mean, args.train_dataset_std, args.sampling_rate, args.max_length, args.num_mel_bins)
